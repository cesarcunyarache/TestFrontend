      ...
      <div className="border rounded-lg bg-white p-6  ">
        ...
        <div className="leyenda pt-4">
          <ul className="flex flex-row">
            ...
            <li className="pr-4">
              {" "}
              <span className="bg-blue-500 rounded text-blue-500">
                ....
              </span>{" "}
              Disponible
            </li>
            <li className="pr-4">
              {" "}
              <span className="bg-green-600 rounded text-green-600">
                ....
              </span>{" "}
              Seleccionado
            </li>
