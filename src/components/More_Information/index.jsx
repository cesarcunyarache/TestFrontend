		...
		<div className="pt-8">
			...
			<div className="redes_sociales">
				...
				<div className="Enlaces pt-2 pl-2 text-[14px]">
					<p>
						<span className="pr-2">
							<a className="text-red-700 font-semibold hover:bg-red-800 hover:text-white border rounded pt-1 pb-1 pr-4 pl-4" href="https://instagram.com/terrazabravazo">Instagram</a>
						</span>
						<span>
