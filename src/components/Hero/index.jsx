...
export default function Hero() {
	...
	return (
		<div id="Inicio" className={`${styles.hero} container m-auto w-auto`}>
			<div className={styles.information}>
				<h1 className={`${styles.headline} text-black font-bold leading-[40px] text-center p-4`}>¡Eleva tu experiencia con los
					<span className="text-red-700"> Platillos </span>
					Más Irresistibles de la ciudad!
				</h1>

				<div className={`${styles.button_action} discover text-white text-[12px] font-bold text-center mx-auto bg-red-700 w-[130px] p-2 rounded-[5px] animate-bounce hover:bg-dark_red cursor-pointer`}>
					<p>RESERVA AHORA</p>
				</div>
			...
			<div id="sobre-nosotros" className={`${styles.body_page} pr-8 pl-8`}>
				...
				<div className={`${styles.content_lateral}`}>
					...
					<div className={`${styles.menu_information}`}>
						<div className="menu p-4 border rounded border-[#d8d9db]">
							<p className="text-[18px] text-center font-bold">
								Visualiza nuestra carta
							</p>
							<div className="pt-2">
								<a className="border border-[#d8d9db] rounded p-2 text-[14px] text-red-700 font-semibold hover:text-white hover:bg-red-700" href="/menuBravazo.pdf" download="MenuTerrazaBravazo.pdf">
			...
			<div id="Experiencias" className={`${styles.event_experience} pl-8 pr-8`}>
				<div className={`${styles.event} event pb-4`}>
					<div className="pt-4">
						<h2 className="text-[18px] font-bold pb-2">
							Eventos
						</h2>
						<div className={`${styles.content_event} border rounded p-4 items-center`}>
							<div className={`${styles.image_event}`}>
								<Image src="/evento.svg" alt="Evento image" width={298} height={150} />
							</div>
