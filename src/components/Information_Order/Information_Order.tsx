...
export type Information_OrderProps = {
}

const Information_Order: React.FC<Information_OrderProps> = ({ }) => {
	return (
		<div className="information_order border p-4 rounded border-[#d8d9db]">
			...
			<a className="border p-2 rounded border-[#d8d9db] text-[14px] font-semibold text-light_red hover:text-white hover:bg-light_red" href="tel:+51976569677">
				+51 976 569 677
			</a>
...
export default Information_Order;
